...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
        	...
        	$.post("act_User",{action: '5'},function(responseJson) {
    			 if (responseJson.check == "fail") {
   		        	alert("Loaddata failed!");
		                return;       		                  	
	 		        }
    			 $.each(responseJson, function(index, product) {    // Iterate over the JSON array.
   		        	$("#authorityID > option").remove();
   		        	$("#authorityID2 > option").remove();
     		 	});
    			 
    			 $.each(responseJson, function(index, product) {    // Iterate over the JSON array.
    				 if(product.authorityName!='Student'){
  		        	$("#authorityID").append($("<option>").val(product.authorityID)
	     		       				.text(product.authorityName))
	     		    $("#authorityID2").append($("<option>").val(product.authorityID)
	     		       				.text(product.authorityName))
    				 }
        	 ...
        	 $.get("act_User", function(responseJson) {
 		            ...
 		            $("<tr>").appendTo($table)                     // Create HTML <tr> element, set its text content with currently iterated item and append it to the <table>.
 		                ...
 		                .append($("<td>")
 		                		.append($("<a>")
 		                				...
 		                				.click(function(){
 		                		           	 $.post("act_User",{action: '3',userID : product.userID}, 
 		                		...
 		                		.append($("<a>")
 		                				...
 		                				.click(function(){
 		                					var retVal = confirm("Do you really want to delete this?");          	
	 		           	                    if( retVal == true ){
	 		           	                    	$.post("act_User",{action: '4',userID : product.userID}, 
	   		                						function(responseJson) {  
		   		                						if (responseJson.check == "fail") {
        	 ...
        	 function reload(){
        		 $.get("act_User", function(responseJson) {          // Execute Ajax GET request on URL of "someservlet" and execute the following function with Ajax response JSON...
      		        //var $table = $("<table>").appendTo($("#somediv")); // Create HTML <table> element and append it to HTML DOM element with ID "somediv".
      		        if (responseJson.check == "fail") {
      		        	alert("Loaddata failed!");
		                return;       		                  	
        	...
        	$('#add1').click(function(){
           	 ...
           	 $.post("act_User",{action: '1',username2 : $('#username').val(),password : $('#password').val(),
           		fullName : $('#fullname').val(),sex : sex,
           		doB : $('#doB').val(),phoneNumber : $('#phonenumber').val(),
           		email : $('#email').val(),address : $('#address').val(), salary: $('#luong').val(),authorityID: $('#authorityID').val()},
        	...
        	$('#edit1').click(function(){
           	 ...
           	 $.post("act_User",{action: '2',studentID : $('#studentID2').val(),username2 : $('#username2').val(),password : $('#password2').val(),
   ...
   <!-- Form add student -->
    <div class="md-modal md-effect-7" id="modal-studentuser">
        <div class="md-content">
            ...
            <form id="login_form_user" class="was-validated pre-scrollable2" action="" method="">
                <fieldset>
                    <div id="left_hiddenform">
                        ...
                        <div class="luong">
                            <input type="text" name="salary" id="luong" placeholder="Enter Salary">
                        </div>
                    </div>
                    <!-- end left_hiddenform -->
                    ...
                    <div id="right_hiddenform">
                       ...
                       <div>
                        ...
                        <div class="custom-controls-stacked d-block my-3">
                           ...
                           <div>
                                <label for="time" class="lbl_time" style="margin-bottom: 35px !important;">Date of birth</label> 
                                <input name="doB" type="date" id="doB" class="input_time" required />
                            </div>
                            
                            <div>
	                            <label for="text" class="lbl_contentgr">AuthorityID</label style="float: left;">
	                            <select id="authorityID" class="custom-select d-block my-3 select_contentgr" required
	                            style="float: right;margin-right:15px;width:62%;margin-top: -5px !important;">
    ...
    <div class="md-modal114" id="modal-studentuser2">
        <div class="md-content">
            ...
            <form id="login_form_user2" class="was-validated pre-scrollable2" action="" method="">
                <fieldset>
                    <div id="left_hiddenform">
                    	<div>
                    ...
                    <div id="right_hiddenform">
                        ...
                        <div class="luong">
                            <input type="text" name="salary" id="luong2" placeholder="Enter Salary">
                        </div>
                       ...
                       <div>
                        ...
                        <div class="custom-controls-stacked d-block my-3">
                           ...
                           <div>
                                <label for="time" class="lbl_time" style="margin-bottom: 35px !important;">Date of birth</label> 
                                <input name="doB" type="date" id="doB2" class="input_time" required />
                            </div>
                            
                            <div>
	                            <label for="text" class="lbl_contentgr">AuthorityID</label style="float: left;">
	                            <select id="authorityID2" class="custom-select d-block my-3 select_contentgr" required
	                            style="float: right;margin-right:15px;width:62%;margin-top: -5px !important;">
	                                        <!--  <option value="">Choose Exam ID</option>
	                                        <option value="1">Exam 01</option>
	                                        <option value="2">Exam 02</option>
  ...
  <style>
    ...
    <!-- Authority Manegement -->
     ...
     <div class="container tieude" id="content-gr" style="margin-left:100px;margin-right:100px;">
         		<h2 class="text-center" style="color: red;font-weight: bold;margin-bottom: 20px !important;">USER MANEGEMENT</h2>
        <p class="text-right">
        <a class="md-trigger btn" data-modal="modal-studentuser" id="btn_left"><button type="submit" class="btn add-employee">
        	<i class="fa fa-plus" aria-hidden="true"></i>Add User</button></a>
        </p>
