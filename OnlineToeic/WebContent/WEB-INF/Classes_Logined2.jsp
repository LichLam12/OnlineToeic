		               ...
		               .append($("<div>").addClass("mdl-card__title mdl-card--expand")
		  				...
		  				.append($("<div>").addClass("mdl-card__actions mdl-card--border")
		              			.append($("<a>").addClass("mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect")
		              					...
		              					.click(function(){
		               		           	 $.post("act_StudentClass",{action: '1',studentID : studentID,classID : product.classID}, 
		               		           		function(responseJson) { 
			                		           	
			              						alert("Successlly Register.");
		               		     		    }
		               		           	 );
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0 10px">
		...
		<div class="collapse navbar-collapse lead" id="navbar">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="ForwardToLoginedHome2?username=${perinfo.username }">ABOUT</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="ForwardToClasses2?username=${perinfo.username }">CLASSES</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="ForwardToLoginedHome2?username=${perinfo.username }">NEWS</a>
				</li>
				<li class="nav-item">
...
<span id="yourname">${perinfo.studentID }</span>
<style>
