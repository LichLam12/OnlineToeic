...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
        	...
        	$.post("act_Student",{action: '3',studentID : studentID}, 
        ...
        $('#save_on').click(function(){ 
            ...
            check_email2();
     		...
     		if(error_password2 == false && error_fullname2 == false &&
              error_phonenumber3 == false && error_address2 == false && error_email2 == false) {
            	 ...
            	 $.post("act_Student",{action: '6',studentID : $('#studentID2').val(),username2 : $('#username2').val(),password : $('#password2').val(),
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="phonenumber" id="phonenumber3" placeholder="Mobie phone" disabled>
                            </div>
                        </div>                 
                    </div>
                </div>
