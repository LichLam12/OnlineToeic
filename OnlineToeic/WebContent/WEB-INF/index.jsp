...
<!--                 </h4> -->
                ...
                <form id=login_form7 action="LoginController" method="post">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <div id="btn">
		                    	<div id="btn_login" style="float:left;">
			                        <input class="animated" type="submit" value="LOGIN" style="padding: 5px 70px 5px 20px !important;">
			                    </div>
		                        <input id="closebtn_form2" data-dismiss="modal-20" aria-label="Close"
		                   ...
		                   document.getElementById("btn_login").onclick = function abc3() {
		                                      $("#modal-20").hide();
		                                  };
		                    </script>
                        </div>
        ...
        <div class="md-content">
            ...
            <form id="login_form_studentuser2" class="was-validated pre-scrollable2" action="" method="">
                       ...
                       <div>
                        ...
                        <div class="custom-controls-stacked d-block my-3">
                           ...
                           <div>
                                ...
                                <input type="date" name="doB" id="doB2" class="input_time" required />
                            </div>
                ...
                <div>
                    <div id="btn">
                        <div id="btn_register" style="float:left;">
                        	<input class="animated" type="button" value="REGISTER">
                        </div>
                   ...
                   document.getElementById("btn_register").onclick = function abc3() {
                                      $("#modal-studentuser2").hide();
                                  };
                    </script>
                </div>
    ...
    margin-bottom: 10px;
        ...
        <div id="right">
           <center>
            <h1 class="jumbotron-heading">A BRIGHTER FUTURE STARTS HERE</h1>
            <p class="lead text-muted">Welcome to the online toeic exam website of Monggogo toeic center. If you are already a member, click the button below. If you are not a member, please click the register button to join our community..</p>
          
            <div id="btn">
                <a class="md-trigger btn btn_login" data-modal="modal-20" id="btn_left">
                    <span class="txt">SIGN IN</span>
                    <span class="round"><i class="fa fa-chevron-right"></i></span>
                </a>

                <a class="md-trigger btn btn_register" data-modal="modal-studentuser2" id="btn_left1">
